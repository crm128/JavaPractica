...
matriz M en la cual empieza el primer elemento de la submatriz P. */
    public static void main(String[] args) {
        ...
        if (funciones.contenida(M, P)) {
            System.out.println("La matriz P esta contenida en M");
        } else {
            System.out.println("La matriz P no esta contenida en M");
        }

        if (funciones.contenida(M, Q)) {
            System.out.println("La matriz Q esta contenida en M");
        } else {
            System.out.println("La matriz Q no esta contenida en M");
        }
